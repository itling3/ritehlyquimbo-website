        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-3">
              {SERVICES.map((service, i) => (
                <button 
                  key={i} 
                  onClick={(e) => handleLinkClick(e, service.id, true)}
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <button onClick={(e) => handleLinkClick(e, 'about')} className="text-sm text-gray-500 hover:text-blue-400 transition-colors font-medium text-left">About Me (Mission)</button>
              <button onClick={(e) => handleLinkClick(e, 'contact')} className="text-sm text-gray-500 hover:text-blue-400 transition-colors font-medium text-left">Contact Me</button>
              <button onClick={(e) => handleLinkClick(e, 'portfolio-overview')} className="text-sm text-gray-500 hover:text-blue-400 transition-colors font-medium text-left">Portfolio Results</button>
              ...
              <button onClick={(e) => handleLinkClick(e, 'pricing')} className="text-sm text-gray-500 hover:text-white transition-colors font-medium text-left">SEO Pricing Blueprints</button>
              <button onClick={(e) => handleLinkClick(e, 'local-seo-pricing')} className="text-sm text-gray-500 hover:text-white transition-colors font-medium text-left">Local SEO Pricing Tiers</button>
              <button onClick={(e) => handleLinkClick(e, 'web-dev-pricing')} className="text-sm text-gray-500 hover:text-white transition-colors font-medium text-left">Web Dev Pricing Packages</button>
              <button onClick={(e) => handleLinkClick(e, 'resume')} className="text-sm text-gray-500 hover:text-white transition-colors font-medium text-left">Download Resume (CV)</button>
