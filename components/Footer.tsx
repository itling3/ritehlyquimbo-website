        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-16">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5 md:gap-3">
              ...
              <Link to="/resources" className="text-xs text-blue-400 hover:text-white transition-colors font-bold text-left uppercase tracking-tighter italic">Growth Resources</Link>
