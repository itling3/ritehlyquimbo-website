    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] glass-morphism border-b border-white/10 h-[72px] flex items-center px-4 md:px-6">
      <div className="max-w-7xl mx-auto flex justify-between items-center w-full relative">
        ...
        <div className="hidden lg:flex items-center gap-6 xl:gap-8 text-[11px] font-bold uppercase tracking-widest text-gray-400">
                    ...
                    <div key={idx} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        {cat.services.map((s) => (
                          <button 
                            key={s.id} 
                            onClick={() => handleLinkClick(s.id, true)} 
          ...
          >
            <button 
              onClick={() => handleLinkClick('portfolio-overview')}
                    ...
                    <div key={idx} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        {cat.studies.map((s) => (
                          <button 
                            key={s.id} 
                            onClick={() => handleLinkClick(s.id, false)} 
          ...
          <button onClick={() => handleLinkClick('about')} className="hover:text-white transition-colors">About</button>
          <button onClick={() => handleLinkClick('contact')} className="hover:text-white transition-colors">Contact</button>
          <button onClick={() => handleLinkClick('resume')} className="text-blue-500 hover:text-blue-400 font-black transition-colors">Resume</button>
        ...
        <div className="flex-1 overflow-y-auto bg-transparent px-6 pt-2 pb-72">
          ...
          <div className="space-y-4">
            ...
            <div className={`rounded-3xl border transition-all duration-300 ${mobileExpanded === 'services' ? 'bg-white/5 border-blue-500/30' : 'bg-transparent border-white/5'}`}>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${mobileExpanded === 'services' ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}>
                <div className="px-6 pb-6 pt-2 space-y-8">
                  ...
                  <button 
                    onClick={() => handleLinkClick('services-overview')}
                    className="w-full py-5 border border-blue-500/30 bg-blue-600/10 rounded-xl text-blue-400 font-black text-[11px] uppercase tracking-widest italic"
                  >
            ...
            <div className={`rounded-3xl border transition-all duration-300 ${mobileExpanded === 'portfolio' ? 'bg-white/5 border-purple-500/30' : 'bg-transparent border-white/5'}`}>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${mobileExpanded === 'portfolio' ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}>
                <div className="px-6 pb-6 pt-2 space-y-8">
                  ...
                  <button 
                    onClick={() => handleLinkClick('portfolio-overview')}
                    className="w-full py-5 border border-purple-500/30 bg-purple-600/10 rounded-xl text-purple-400 font-black text-[11px] uppercase tracking-widest italic"
                  >
            ...
            <div className={`rounded-3xl border transition-all duration-300 ${mobileExpanded === 'pricing' ? 'bg-white/5 border-blue-500/30' : 'bg-transparent border-white/5'}`}>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${mobileExpanded === 'pricing' ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}>
            ...
            <div className="grid grid-cols-1 gap-3 pt-6">
              {[
                { id: 'about', label: 'About Me', color: 'text-gray-300' },
                { id: 'contact', label: 'Contact', color: 'text-gray-300' },
                { id: 'resume', label: 'Resume', color: 'text-blue-500' }
              ].map(link => (
                <button 
                  key={link.id} 
