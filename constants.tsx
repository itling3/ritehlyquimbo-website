...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    metaDescription: 'See how Mae Wellness scaled organic traffic with holistic SEO strategies. Real-world case study on wellness sector growth and keyword domination.',
  ...
  },
  {
    ...
    metaDescription: 'Monstore Self Storage achieved 1.7M+ impressions using aggressive local SEO and technical audits. Explore the logistics SEO strategy that drove massive visibility.',
  ...
  },
  {
    ...
    metaDescription: 'Excel Scotland dominated luxury custom home search with semantic intent mapping. Case study on luxury construction SEO and lead generation.',
  ...
  },
  {
    ...
    metaDescription: 'Kinloss Self Storage saw a 1.7% CTR boost using precision intent targeting. Learn how high-intent local SEO drives occupancy and bookings.',
  ...
  },
  {
    ...
    metaDescription: 'British School of Languages increased leads by 35% with targeted educational SEO. Case study on scaling language course sign-ups organically.',
  ...
  },
  {
    ...
    metaDescription: 'Ryan King Team (The Chattanooga Life) secured #1 GMB spots, driving daily inbound real estate calls. Real estate GMB optimization case study.',
...
export const SERVICE_DETAILS: Record<string, ServiceContent> = {
  'keyword-research': {
    ...
    metaDescription: 'Strategic keyword research and intent mapping to identify high-revenue, low-competition opportunities. Start ranking for terms that drive sales.',
  ...
  'on-page-seo': {
    ...
    metaDescription: 'Technical on-page SEO services for maximum crawlability and resonance. Advanced schema markup, semantic entity optimization, and internal link silos.',
  ...
  'off-page': {
    ...
    metaDescription: 'High-authority digital PR and white-hat backlink acquisition. Build an unassailable domain moat with elite outreach and authority building.',
  ...
  'content-creation': {
    ...
    metaDescription: 'Expert-led SEO content strategy. We combine deep subject matter expertise with search optimization to create high-ranking, helpful content.',
  ...
  'local-seo': {
    ...
    metaDescription: 'Dominate the Google Map Pack and local search results. Hyper-local SEO strategies for storefronts and service area businesses.',
  ...
  'ecommerce-seo': {
    ...
    metaDescription: 'Scale your online store with ecommerce SEO. Optimize category structures, product pages, and faceted navigation for maximum sales growth.',
  ...
  'google-ads': {
    ...
    metaDescription: 'Precision-targeted Google Ads and search engine marketing (SEM). Immediate lead generation and ROI-focused PPC management services.',
  ...
  'ai-automation': {
    ...
    metaDescription: 'Scale business operations with custom AI workflows and agent integration. Expert AI automation systems for data analysis and content scaling.',
  ...
  'lead-generation': {
    ...
    metaDescription: 'Predictable B2B lead generation systems. Combining SEO authority with automated outreach to build a high-quality sales pipeline.',
  ...
  'virtual-assistance': {
    ...
    metaDescription: 'High-level operational support and specialized virtual assistance. Streamline technical workflows and scale your business capacity.',
  ...
  'web-design': {
    ...
    metaDescription: 'High-performance, SEO-first web development. Conversion-centered digital architecture built for speed and long-term search dominance.',
  ...
  'topical-maps': {
    ...
    metaDescription: 'Establish unshakeable semantic authority with topical mapping. Pillar-cluster content strategies that dominate search engines.',
